import inspect, logging, os, pydoc, sys
...
LOGGER = logging.getLogger('flaskBase-migrate')
...
class DatabaseManager:
    ...
    def info(self):
        ...
        LOGGER.info('Arguments: {}'.format(len(kwargs)))
    ...
    def downgrade(self, target=None):
        ...
        for name in diff:
            ...
            # Or if we are at the end of the line, don't run anymore.
            if (not target or target == name):  break
        return True
